...
async function main() {
  ...
  if (network.name == "localhost") {
    ...
    // const tx1 = await NFTMarket2Proxy.safeMint("0xef7b473C547a4c5842c25C924E7513C0aE134Dc4", "./NFTMarket2.json");
    // await tx1.wait();
    // const tx2 = await NFTMarket2Proxy.safeBatchMint("0xef7b473C547a4c5842c25C924E7513C0aE134Dc4", 2, "./NFTMarket2.json");
    // await tx2.wait();
  }
